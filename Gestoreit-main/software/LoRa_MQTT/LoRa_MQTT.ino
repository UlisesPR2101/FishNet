...
// ranges from 6-12,default 7 see API docs Fator de esparcimiento
...
// WIFI: conexión a Router o Punto de anclaje
char* ssid = "Access_point";
char* password = "12345678";

// MQTT: Servidor
char* MQTT_IP = "192.168.0.104";   // Direccion ip del servidor MQTT
...
char MQTT_TOPIC_D2[50] = "LoRa_D2/AQUAYET";          //Tópico MQTT para voltaje
